...
import { removeOne } from "@/redux/fetures/pcBuildSlice";
...
const CategoryPage = ({ categoryData }) => {
  ...
  return (
    <div className="bg-slate-200 rounded-lg shadow-md px-2 block lg:flex justify-between items-center gap-3 ">
      <div className="block lg:flex  items-center justify-center gap-3 mb-2">
        <Image
          src={categoryData?.imageLink}
